...
public class UserControllerTest {
    ...
    {
        when(trackService.saveUser(any())).thenReturn(track);
    ...
    {
        when(trackService.updateUser(any())).thenReturn(track);
    ...
    {
        when(trackService.deleteUser(anyInt())).thenReturn(true);
